...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, bg = "#232a2e" })
...
globalkeys = gears.table.join(
    awful.key({ }, "XF86AudioRaiseVolume",  function () awful.spawn("pw-volume change +10%") end ),
...
-- }}}
--
awful.spawn.with_shell("feh --bg-scale ~/Pictures/wallpapers/Forest.jpg")
